...
> доказаны live, 0 false-green.** Механика проверяется ДЕТЕРМИНИРОВАННО в CI (**193 проверки**). Точная
