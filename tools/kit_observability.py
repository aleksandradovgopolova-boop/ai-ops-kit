...
`import ai_ops_kit...` падает при запуске файла напрямую (`python3 tools/kit_observability.py`)
...
if __name__ == "__main__":
    ...
    runpy.run_module("ai_ops_kit.devtools.kit_observability", run_name="__main__", alter_sys=True)
else:
