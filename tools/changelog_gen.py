...
`import ai_ops_kit...` падает при запуске файла напрямую (`python3 tools/changelog_gen.py`)
...
if __name__ == "__main__":
    ...
    runpy.run_module("ai_ops_kit.devtools.changelog_gen", run_name="__main__", alter_sys=True)
else:
