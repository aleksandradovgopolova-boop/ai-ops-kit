"""Совместимость: плоское имя effect_metrics -> ai_ops_kit.lifecycle.effect_metrics.
...
if __name__ == "__main__":
    ...
    runpy.run_module("ai_ops_kit.lifecycle.effect_metrics", run_name="__main__", alter_sys=True)
else:
    import ai_ops_kit.lifecycle.effect_metrics as _target
