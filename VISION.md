...
> **О нумерации уровней.** Этапы жизненного цикла кит называет словами (Discovery,
> Product Definition, …), а не номерами вида «Ln». Не путайте их с **глубиной
> спецификации** — это отдельная ось из четырёх уровней **L0–L3** (L0 QUICK … L3
> CRITICAL, см. `ai_ops_kit/gates/spec_levels.py`). Уровней L4/L5 в ките нет ни на одной
> из осей: нумерация «L0–L5» встречается только в незавершённых черновиках (RR-018/DP-117)
> и в код не заведена.
