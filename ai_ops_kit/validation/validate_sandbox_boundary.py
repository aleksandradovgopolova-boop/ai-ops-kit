...
KNOWN_UNCLOSED = {
    ...
    # ai_ops_cli_intents.py (рефактор deepcut-ai-ops-cli, 2026-09-03), а затем — при разрезе
    # монолита интентов (refactor-cli-intents-monolith, 2026-09-10) — в ai_ops_cli_product.py.
    # Сам текст сухого прогона не менялся, поэтому находка та же — сменился лишь файл-носитель.
    "ai_ops_kit/cli/ai_ops_cli_product.py":
