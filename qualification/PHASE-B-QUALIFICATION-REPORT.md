...
Незакрытые пункты — не дефекты движка, а внешние гейты (способность провайдера, UI-тулчейн). Их
закрытие возобновляется по появлении сильного ключа и React-фикстуры; движок к этому готов.
