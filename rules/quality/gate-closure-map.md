...
Замер 19.08.2026: из 35 гейтов **19 не имеют исполняемого валидатора**. Их закрывает заключение
...
| `documentation_updated` | writer | совещательный | documentation-steward |

**Итого: 16 машиной, 17 судьёй, 2 писателем, 0 человеком** (гейт `security` поднимается до
...
Два гейта в состоянии `writer` (`documentation_drift`, `documentation_updated`) — самый слабый
случай, и он назван прямо: их закрывает та же стадия, что и писала. Это кандидаты либо на
валидатор, либо на судью.
