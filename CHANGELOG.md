...
**Защиты от халявы:** освобождается только то, что подтверждённый профиль (writer≠judge)
объявил отсутствующим; освобождение видно в warnings; объявленная проверка не освобождается.
