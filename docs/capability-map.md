...
| 4 | Доля фич с реальным результатом после релиза | виден ли реальный исход выпуска (сейчас честный каркас «не измерено») |
| 5 | Доля решений, опирающихся на прошлые результаты | стал ли кит обучающимся, а не накопителем (сейчас честный каркас «не измерено») |
