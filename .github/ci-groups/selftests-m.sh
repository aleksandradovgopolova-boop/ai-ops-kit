...
cd "$(dirname "$0")/../.."
python3 -m pytest tests/ -q -m slow -k "not (test_a or test_b or test_c or test_d or test_e or test_f or test_g or test_h or test_i or test_j or test_k or test_l)"
