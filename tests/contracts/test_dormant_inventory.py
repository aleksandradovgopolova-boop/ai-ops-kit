...
KNOWN_DORMANT: dict[str, str] = {
    ...
    # storybook_query УБРАН из KNOWN_DORMANT (#613, 2026-09-07): построен живой потребитель
    # UI-контекста — context_compiler.build_payload при ui_changed вкладывает навигацию по дизайн-
    # системе (related_stories + каталог компонентов) в контекст пишущего агента. Больше не дормантен.
}
