...
def test_the_pipeline_puts_the_breakdown_into_run_report_json():
    ...
    # #958 + P0 №5 (#982): в ЛИЦО человеку «Проверено» печатают УРОВНЯМИ ЗНАНИЯ (что известно и что
    # ещё неизвестно) продуктовыми словами, а не счётом «проверено машиной X из Y; остальное — мнение: id».
    assert 'knowledge_readout' in src, "человеку «Проверено» не сводят уровнями знания"
